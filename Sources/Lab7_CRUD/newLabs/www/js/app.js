...
.controller("RegisterController", function ($scope, $parse, $http, $httpParamSerializerJQLike, LoginThing) {
    ...
    //        console.log("This is the user... " + userTest);
    //    $http({
    //        method: 'GET',
    //        url : "https://api.mongolab.com/api/1/databases/lab7/collections?apiKey=C3gXPpycyrwWjXzCd11nzyXWl5HDM_gf",
    //        contentType: "application/json",
    //    
    //    }).then(function(data){
    //        console.log("got the data");
    //        console.log($http.data);
    //        if ($http.data.password == userPass)
    //        {
...
// return $http.get(baseURL + '/databases/lab7/collections/users?q={"user: "' + userN + '}&' + apiKey).then(function (response) {